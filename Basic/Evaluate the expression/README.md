<h2><a href="https://practice.geeksforgeeks.org/problems/evaluate-the-expression0307/1?page=1&difficulty=Basic&status=unsolved&sprint=94ade6723438d94ecf0c00c3937dad55&sortBy=submissions">Evaluate the expression</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number n, find the value of below expression:<br>
